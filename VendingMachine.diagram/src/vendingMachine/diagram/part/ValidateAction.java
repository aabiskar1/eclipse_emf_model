...
public class ValidateAction extends Action {
	...
	*/
	public ValidateAction(IWorkbenchPage page) {
		setText(vendingMachine.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	*/
	public static void runValidation(View view) {
		try {
			if (vendingMachine.diagram.part.VendingMachineDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	*/
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		vendingMachine.diagram.providers.VendingMachineValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	*/
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			vendingMachine.diagram.providers.VendingMachineMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	*/
	private static void createMarkers(IFile target, IStatus validationStatus, DiagramEditPart diagramEditPart) {
		...
		vendingMachine.diagram.part.VendingMachineDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new vendingMachine.diagram.part.VendingMachineDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(),
				collectTargetElements(rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = vendingMachine.diagram.part.VendingMachineDiagramEditorUtil.findView(diagramEditPart,
	...
	*/
	private static void addMarker(EditPartViewer viewer, IFile target, String elementId, String location,
		...
		vendingMachine.diagram.providers.VendingMachineMarkerNavigationProvider.addMarker(target, elementId, location,
