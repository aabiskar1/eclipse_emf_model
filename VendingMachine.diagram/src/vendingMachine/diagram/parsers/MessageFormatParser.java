 ...
 * 
 */
package vendingMachine.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(vendingMachine.diagram.part.VendingMachineDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(vendingMachine.diagram.part.Messages.MessageFormatParser_InvalidInputError,
