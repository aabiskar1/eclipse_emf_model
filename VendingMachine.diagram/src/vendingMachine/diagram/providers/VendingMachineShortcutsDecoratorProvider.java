 ...
 * @generated
 */
public class VendingMachineShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = vendingMachine.diagram.part.VendingMachineDiagramEditorPlugin.getInstance()
