 ...
 * @generated
 */
public class VendingMachineMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = vendingMachine.diagram.part.VendingMachineDiagramEditorPlugin.ID
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			vendingMachine.diagram.part.VendingMachineDiagramEditorUtil.selectElementsInDiagram(editor,
