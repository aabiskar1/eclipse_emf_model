 ...
 * @generated
 */
public class VendingMachineValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = vendingMachine.diagram.part.VendingMachineDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed)
					.getEditorPart() instanceof vendingMachine.diagram.part.VendingMachineDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && vendingMachine.diagram.edit.parts.VendingMachineEditPart.MODEL_ID
