 ...
 * @generated
 */
public class VendingMachineDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public VendingMachineDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof vendingMachine.diagram.navigator.VendingMachineDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((vendingMachine.diagram.navigator.VendingMachineDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new vendingMachine.diagram.navigator.VendingMachineDomainNavigatorItem((EObject) objects[i],
