 ...
 * @generated
 */
public class UserCoinTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UserCoinTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = vendingMachine.diagram.providers.VendingMachineParserProvider.getParser(
					vendingMachine.diagram.providers.VendingMachineElementTypes.UserCoin_2004, getParserElement(),
