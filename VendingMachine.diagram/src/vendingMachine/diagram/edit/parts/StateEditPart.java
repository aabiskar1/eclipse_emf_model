...
public class StateEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new vendingMachine.diagram.edit.policies.StateItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof vendingMachine.diagram.edit.parts.StateTextEditPart) {
			((vendingMachine.diagram.edit.parts.StateTextEditPart) childEditPart)
	...
	*/
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 107, 114, 110);
