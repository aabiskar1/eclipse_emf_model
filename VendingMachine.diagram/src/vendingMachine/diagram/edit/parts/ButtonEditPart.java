...
public class ButtonEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new vendingMachine.diagram.edit.policies.ButtonItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof vendingMachine.diagram.edit.parts.ButtonTextEditPart) {
			((vendingMachine.diagram.edit.parts.ButtonTextEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureButtonLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 105, 218, 203);
