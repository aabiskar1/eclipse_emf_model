 ...
 * @generated
 */
public class MessageTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MessageTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = vendingMachine.diagram.providers.VendingMachineParserProvider.getParser(
					vendingMachine.diagram.providers.VendingMachineElementTypes.Message_2002, getParserElement(),
