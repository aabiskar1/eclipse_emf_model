 ...
 * @generated
 */
public class TransitionTextEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(vendingMachine.diagram.part.VendingMachineVisualIDRegistry
				.getType(vendingMachine.diagram.edit.parts.TransitionTextEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public TransitionTextEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new vendingMachine.diagram.edit.policies.VendingMachineTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = vendingMachine.diagram.providers.VendingMachineParserProvider.getParser(
					vendingMachine.diagram.providers.VendingMachineElementTypes.Transition_4001, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					vendingMachine.diagram.edit.parts.VendingMachineEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
