 ...
 * @generated
 */
public class ButtonTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ButtonTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = vendingMachine.diagram.providers.VendingMachineParserProvider.getParser(
					vendingMachine.diagram.providers.VendingMachineElementTypes.Button_2003, getParserElement(),
