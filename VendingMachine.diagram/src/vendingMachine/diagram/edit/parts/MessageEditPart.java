...
public class MessageEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new vendingMachine.diagram.edit.policies.MessageItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof vendingMachine.diagram.edit.parts.MessageTextEditPart) {
			((vendingMachine.diagram.edit.parts.MessageTextEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMessageLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	 ...
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 17, 238, 105);
