 ...
 * @generated
 */
public class StateTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StateTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = vendingMachine.diagram.providers.VendingMachineParserProvider.getParser(
					vendingMachine.diagram.providers.VendingMachineElementTypes.State_2001, getParserElement(),
