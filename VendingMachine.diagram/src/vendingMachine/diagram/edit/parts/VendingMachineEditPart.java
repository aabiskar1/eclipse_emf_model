 ...
 * @generated
 */
public class VendingMachineEditPart extends DiagramEditPart {

	/**
	* @generated
	*/
	public final static String MODEL_ID = "VendingMachine"; //$NON-NLS-1$
	...
	* @generated
	*/
	public VendingMachineEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new vendingMachine.diagram.edit.policies.VendingMachineItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new vendingMachine.diagram.edit.policies.VendingMachineCanonicalEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicyWithCustomReparent(
				vendingMachine.diagram.part.VendingMachineVisualIDRegistry.TYPED_INSTANCE));
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new vendingMachine.diagram.edit.commands.VendingMachineCreateShortcutDecorationsCommand(
