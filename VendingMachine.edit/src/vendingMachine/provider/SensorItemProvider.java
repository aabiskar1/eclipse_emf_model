...
/**
 * This is the item provider adapter for a {@link vendingMachine.Sensor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SensorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachinePackage.Literals.SENSOR__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Sensor_data_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Sensor_data_feature", "_UI_Sensor_type"),
				 VendingMachinePackage.Literals.SENSOR__DATA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Sensor.class)) {
			case VendingMachinePackage.SENSOR__NAME:
			case VendingMachinePackage.SENSOR__DATA:
