...
/**
 * This is the item provider adapter for a {@link vendingMachine.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_text_feature", "_UI_Transition_type"),
				 VendingMachinePackage.Literals.TRANSITION__TEXT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachinePackage.Literals.TRANSITION__FROM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VendingMachinePackage.Literals.TRANSITION__TO,
				 true,
				 false,
				 true,
				 null,
