...
/**
 * This is the item provider adapter for a {@link vendingMachine.Message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageItemProvider extends EventItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Message_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Message_status_feature", "_UI_Message_type"),
				 VendingMachinePackage.Literals.MESSAGE__STATUS,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Message.class)) {
			case VendingMachinePackage.MESSAGE__STATUS:
